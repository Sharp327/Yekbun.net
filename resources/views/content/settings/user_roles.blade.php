                        ...
                        <div class="p-2 rounded mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2" style="display: flex; align-items: center; justify-content: center; height:80px">
                                    <input type="text" value="100 MB" id="slider-pips3-input" class="form-control text-center">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="content-group p-0">
                        <div class="p-2 rounded mb-2" style="background-color:#FEE9EA">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2" style="display: flex; align-items: center; justify-content: center; height:80px">
                                    <input type="text" value="10 %" id="slider-pips4-input" class="form-control text-center">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-group p-0 ms-4">
                        <div class="p-2 rounded mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2" style="display: flex; align-items: center; justify-content: center; height:80px">
                                    <input type="text" value="10 Sec" id="slider-pips3-input" class="form-control text-center">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-group p-0 ms-4">
                        <div class="p-2 rounded mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2" style="display: flex; align-items: center; justify-content: center; height:80px">
                                    <input type="text" value="10 min" id="slider-pips3-input" class="form-control text-center">
                                </div>
                            </div>
                        </div>
                    </div>
